...
if ($products->num_rows > 0) {
    ...
    // echo $query = "SELECT * FROM inventory where product_id = " . $id . "";
            ...
            <div class="col-md-6">
                ...
                <form action="" id="add-cart">
                    <div class="d-flex">
                        ...
                        <input class="form-control text-center me-3" id="inputQuantity" type="number" min="1" max="5" value="1" style="max-width: 3rem" name="quantity" />
                        <button class="btn btn-flat btn-primary  flex-shrink-0" type="submit">
...
<section class="py-5 bg-light">
    <div class="container px-4 px-lg-5 mt-5">
        <h2 class="text-light mb-4">Related Products</h2>
