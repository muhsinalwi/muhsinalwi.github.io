    ...
    <div class="container">
        <div class="row">
            <div class="col d-flex justify-content-end mb-2">
                <button class="btn btn-sm btn-flat btn-dark" type="button" id="empty_cart">Empty Cart</button>
            </div>
        </div>
                    ...
                    <div class="d-flex w-100 justify-content-between  mb-2 py-2 border-bottom cart-item">
                        <div class="d-flex align-items-center col-8">
                            ...
                            <div>
                                ...
                                <p class="mb-1 mb-sm-1"><small><b>Price: RM</b> <span class="price"><?php echo number_format($row['price']) ?></span></small></p>
                                <div>
                                    <div class="input-group" style="width:130px !important">
                                        ...
                                        <input type="number" class="form-control form-control-sm qty text-center cart-qty" max="5" placeholder="" aria-label="Example text with button addon" value="<?php echo $row['quantity'] ?>" aria-describedby="button-addon1" data-id="<?php echo $row['id'] ?>" readonly>
        ...
        <div class="d-flex w-100 justify-content-end">
            <a  class="btn btn-sm btn-flat btn-dark" onclick="confirmCheckout()">Checkout</a>
        </div>
    </div>
</section>
<script>
