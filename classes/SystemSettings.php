...
class SystemSettings extends DBConnection
{
	...
	function load_system_info_chatbot()
	{
		// if(!isset($_SESSION['system_info'])){

		$sql_chatbot = "SELECT * FROM system_info where meta_field = 'intro' or meta_field = 'no_result'";
		$qry_chatbot = $this->conn_chatbot->query($sql_chatbot);
		while ($row_chatbot = $qry_chatbot->fetch_assoc()) {
			$_SESSION['system_info'][$row_chatbot['meta_field']] = $row_chatbot['meta_value'];
		}
		// }
	}
...
$_settings_chatbot = new SystemSettings();
$_settings_chatbot->load_system_info_chatbot();
