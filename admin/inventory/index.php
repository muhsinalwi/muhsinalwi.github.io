					...
					<tbody>
						...
						?>
							<tr>
								...
								<td>
									<p class="m-0"><small><b>Product:</b> <?php echo $row['product'] ?></small></p>
								...
								<td align="center">
									...
									<a href="?page=inventory/manage_inventory&id=<?php echo $row['id'] ?>" class="btn btn-sm btn-primary mr-2" title="Edit Item">
